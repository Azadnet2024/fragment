function generateConfig() {
    ...
    const config = {
{ "dns": { "hosts": { "domain:googleapis.cn": "googleapis.com" }, "servers": [ "1.1.1.1" ] }, "inbounds": [ { "listen": "127.0.0.1", "port": 10808, "protocol": "socks", "settings": { "auth": "noauth", "udp": true, "userLevel": 8 }, "sniffing": { "destOverride": [ "http", "tls" ], "enabled": true }, "tag": "socks" }, { "listen": "127.0.0.1", "port": 10809, "protocol": "http", "settings": { "userLevel": 8 }, "tag": "http" } ], "log": { "loglevel": "warning" }, "outbounds": [ { "mux": { "concurrency": mux ? 8 : -1,  "enabled": mux ? "true" : "false", "xudpConcurrency": 8, "xudpProxyUDP443": "reject" }, "protocol": selectedProtocol, "settings": { "vnext": [ { "address": cleanIP, "port": port, "users": [ { "encryption": "none", "flow": "", "id": userUUID, "level": 8, "security": "auto" } ] } ] }, "streamSettings": { "grpcSettings": { "multiMode": false, "serviceName": "" }, "sockopt": { "dialerProxy": "frag", "tcpNoDelay": allowEarlyData ? "true" : "false", }, "network": selectedTransport, "security": tls ? "tls" : "none", "tlsSettings": { "allowInsecure": allowInsecure ? "true" : "false", "alpn": [ "h2" ], "fingerprint": "safari", "publicKey": "", "serverName": randomizedDomain, "shortId": "", "show": false, "spiderX": "" } }, "tag": "proxy" }, { "tag": "frag", "protocol": "freedom", "settings": { "domainStrategy": "AsIs", "fragment": { "packets": tls ? "tlshello" : "1-1", "length": tls ? "10-30" : "1-3", "interval": tls ? "10" : "5" } }, "streamSettings": { "sockopt": { "tcpNoDelay": allowEarlyData ? "true" : "false", } } }, { "protocol": "freedom", "settings": {}, "tag": "direct" }, { "protocol": "blackhole", "settings": { "response": { "type": "http" } }, "tag": "block" } ], "routing": { "domainStrategy": "IPIfNonMatch", "rules": [ { "ip": [ "1.1.1.1" ], "outboundTag": "proxy", "port": "53", "type": "field" }, { "ip": [ "geoip:ir" ], "outboundTag": "direct", "type": "field" } ] } }
    };
